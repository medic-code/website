...
You will realise that everything in your life is a process full of little tasks with feelings and context. In 'Deployed Empathy' breaks this down into three different components that can affect each step or at a process level.
...
Below is a list of resources for further exploration. I encourage you to read Deployed Empathy first as this should give you a framework and expand on the aboves.

#### Books

1. [Deployed Empathy](https://www.amazon.co.uk/Deploy-Empathy-practical-interviewing-customers/dp/173744660X) (322 pages)
