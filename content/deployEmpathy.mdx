...
type: 'blog'
canonicalUrl: 'https://www.aaron-smith.dev/deployEmpathy'
---
...
Moreover, five interviews can, with a well-defined scope get you over 80% of the insights you need. This comes from [research](https://www.nngroup.com/articles/why-you-only-need-to-test-with-5-users/) in usability testing by Tom Landauer and Jacob Nielsen of the Nielson Norman group.
